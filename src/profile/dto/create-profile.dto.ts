...
export class CreateProfileDto {
  ...
  @MaxLength(100, {
    message: 'firstName Must have a maxmum of 100 characters..',
  })
  firstName?: string;
  ...
  @IsString()
  @IsOptional()
  profileImage?: string | null; // i added | null bcz the nest validator remove this feild when i try to update it
}
